...
def get_encoder(name, in_channels=3, depth=5, weights=None, output_stride=32, **kwargs):
    ...
    weights_path = './pretrained_models/efficientnet-b7-dcc49843.pth'
...
class Mymodel(nn.Module):
    def __init__(self,encoder_name="efficientnet-b7",encoder_weights="imagenet",in_channels=3,classes=1):
        ...
        self.decoder_channels= (128, 64, 32, 16, 8)
    ...
    def forward(self, x):
        ...
        ips = torch.normal(0,1,size=(1,)).cuda()

        y = nn.Sigmoid()(results + ips*std)
        return y
